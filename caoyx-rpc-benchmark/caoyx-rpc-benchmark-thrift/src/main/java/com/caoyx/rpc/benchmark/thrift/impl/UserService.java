...
public class UserService {
  ...
  public interface Iface {
    ...
    public boolean userExist(String email) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void userExist(String email, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
    ...
    public void getUser(long id, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void listUser(int pageNo, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_userExist(String email) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class userExist_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String email;
      public userExist_call(String email, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class getUser_call extends org.apache.thrift.async.TAsyncMethodCall {
      private long id;
      public getUser_call(long id, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.id = id;
      }
    ...
    public static class listUser_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int pageNo;
      public listUser_call(int pageNo, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.pageNo = pageNo;
      }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class userExist<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, userExist_args, Boolean> {
      public userExist() {
        super("userExist");
      }
      ...
      public void start(I iface, userExist_args args, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler) throws TException {
    ...
    public static class listUser<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, listUser_args, UserPage> {
      ...
      public AsyncMethodCallback<UserPage> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<UserPage>() { 
      ...
      public void start(I iface, listUser_args args, org.apache.thrift.async.AsyncMethodCallback<UserPage> resultHandler) throws TException {
  ...
  public static class userExist_args implements org.apache.thrift.TBase<userExist_args, userExist_args._Fields>, java.io.Serializable, Cloneable, Comparable<userExist_args>   {
    ...
    static {
      schemes.put(StandardScheme.class, new userExist_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new userExist_argsTupleSchemeFactory());
    }
    ...
    public String toString() {
      StringBuilder sb = new StringBuilder("userExist_args(");
      boolean first = true;
    ...
    private static class userExist_argsStandardSchemeFactory implements SchemeFactory {
      public userExist_argsStandardScheme getScheme() {
        return new userExist_argsStandardScheme();
      }
    }

    private static class userExist_argsStandardScheme extends StandardScheme<userExist_args> {
    ...
    private static class userExist_argsTupleSchemeFactory implements SchemeFactory {
      public userExist_argsTupleScheme getScheme() {
        return new userExist_argsTupleScheme();
      }
    }

    private static class userExist_argsTupleScheme extends TupleScheme<userExist_args> {
  ...
  public static class userExist_result implements org.apache.thrift.TBase<userExist_result, userExist_result._Fields>, java.io.Serializable, Cloneable, Comparable<userExist_result>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new userExist_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new userExist_resultTupleSchemeFactory());
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("userExist_result(");
      boolean first = true;
    ...
    private static class userExist_resultStandardSchemeFactory implements SchemeFactory {
      public userExist_resultStandardScheme getScheme() {
        return new userExist_resultStandardScheme();
      }
    }

    private static class userExist_resultStandardScheme extends StandardScheme<userExist_result> {
    ...
    private static class userExist_resultTupleSchemeFactory implements SchemeFactory {
      public userExist_resultTupleScheme getScheme() {
        return new userExist_resultTupleScheme();
      }
    }

    private static class userExist_resultTupleScheme extends TupleScheme<userExist_result> {
  ...
  public static class listUser_args implements org.apache.thrift.TBase<listUser_args, listUser_args._Fields>, java.io.Serializable, Cloneable, Comparable<listUser_args>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new listUser_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new listUser_argsTupleSchemeFactory());
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("listUser_args(");
      boolean first = true;
    ...
    private static class listUser_argsStandardSchemeFactory implements SchemeFactory {
      public listUser_argsStandardScheme getScheme() {
        return new listUser_argsStandardScheme();
      }
    }

    private static class listUser_argsStandardScheme extends StandardScheme<listUser_args> {
    ...
    private static class listUser_argsTupleSchemeFactory implements SchemeFactory {
      public listUser_argsTupleScheme getScheme() {
        return new listUser_argsTupleScheme();
      }
    }

    private static class listUser_argsTupleScheme extends TupleScheme<listUser_args> {
  ...
  public static class listUser_result implements org.apache.thrift.TBase<listUser_result, listUser_result._Fields>, java.io.Serializable, Cloneable, Comparable<listUser_result>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new listUser_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new listUser_resultTupleSchemeFactory());
    }

    private UserPage success; // required
    ...
    public void setSuccess(UserPage success) {
      this.success = success;
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("listUser_result(");
      boolean first = true;
    ...
    private static class listUser_resultStandardSchemeFactory implements SchemeFactory {
      public listUser_resultStandardScheme getScheme() {
        return new listUser_resultStandardScheme();
      }
    }

    private static class listUser_resultStandardScheme extends StandardScheme<listUser_result> {
    ...
    private static class listUser_resultTupleSchemeFactory implements SchemeFactory {
      public listUser_resultTupleScheme getScheme() {
        return new listUser_resultTupleScheme();
      }
    }

    private static class listUser_resultTupleScheme extends TupleScheme<listUser_result> {
