...
public class ExtensionLoader {
    ...
    private static ConcurrentHashMap<Class, Extension> extensionMap = new ConcurrentHashMap<>();
    ...
    public static Extension getExtension(Class clazz, String name) throws CaoyxRpcException {
        ...
        Extension extension = extensionMap.get(clazz);
        if (extension != null) {
            return extension;
        }
        ...
        Extension existExtension = extensionMap.putIfAbsent(clazz, newExtension);
