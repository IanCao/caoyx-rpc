...
public class LoadBalanceInvokerFilter implements CaoyxRpcFilter {
    ...
    public void doProcess(CaoyxRpcRequest rpcRequest, CaoyxRpcResponse rpcResponse) throws Exception {
        Address targetAddress = loadBalance.loadBalance(rpcRequest.getInvokerInfo(), register.getAllRegister(rpcRequest.getApplicationName(), rpcRequest.getApplicationVersion()));
